        ...
        if (pick_country) {
          for (byte g=0; g<no_genders; g++) {
            ...
            for (int y=1950; y<=1989; y++) {
              for (int a=0; a<=79; a++) {
                huge_statement.append("("+
                                   a+","+a+","+get(a,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30','"+MontaguDB.projection_ids[MontaguDB.UNWPP_ESTIMATES]+"','"+gg+"','"+c3+"','"+MontaguDB.demographic_statistic_types_ids[MontaguDB.INT_POP]+"','"+MontaguDB.source_ids[MontaguDB.UNWPP_2017]+"'),");
              
              }
              huge_statement.append("("+
                "80,120,"+get(80,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30','"+MontaguDB.projection_ids[MontaguDB.UNWPP_ESTIMATES]+"','"+gg+"','"+c3+"','"+MontaguDB.demographic_statistic_types_ids[MontaguDB.INT_POP]+"','"+MontaguDB.source_ids[MontaguDB.UNWPP_2017]+"'),");
            ...
            for (int y=1990; y<=2100; y++) {
              ...
              for (int a=0; a<=99; a++) {
                huge_statement.append("("+
                    a+","+a+","+get(a,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30','"+proj+"','"+gg+"','"+c3+"','"+MontaguDB.demographic_statistic_types_ids[MontaguDB.INT_POP]+"','"+MontaguDB.source_ids[MontaguDB.UNWPP_2017]+"'),");

              }
              huge_statement.append("("+
                  "100,120,"+get(100,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30','"+proj+"','"+gg+"','"+c3+"','"+MontaguDB.demographic_statistic_types_ids[MontaguDB.INT_POP]+"','"+MontaguDB.source_ids[MontaguDB.UNWPP_2017]+"'),");
            }
          }
        }
      }
