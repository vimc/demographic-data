        ...
        if (pick_country) {
          ...
          for (byte g=0; g<no_genders; g++) {
            ...
            for (int y=1990; y<=2100; y++) {
              ...
              for (int a=0; a<=99; a++) {
                stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                    a+","+(a+1)+","+get(a,i3,g,y)+","+y+"0701,"+(y+1)+"0630,"+proj+","+gg+","+i3+","+MontaguDB.INTERPOLATED_POPULATION+","+MontaguDB.UNWPP_2015+")");

              }
              stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                  "100,120,"+get(100,i3,g,y)+","+y+"0701,"+(y+1)+"0630,"+proj+","+gg+","+i3+","+MontaguDB.INTERPOLATED_POPULATION+","+MontaguDB.UNWPP_2015+")");
            }
          }
        }
      } 
