        ...
        if (pick_country) {
          ...
          for (byte g=0; g<no_genders; g++) {
            ...
            for (int y=1950; y<=1989; y++) {
              ...
              stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                  "80,120,"+get(80,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30',"+MontaguDB.UNWPP_ESTIMATES+",'"+gg+"','"+c3+"','"+MontaguDB.INTERPOLATED_POPULATION+"','"+MontaguDB.UNWPP_2015+"')");
            ...
            for (int y=1990; y<=2100; y++) {
              ...
              stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                  "100,120,"+get(100,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30',"+proj+",'"+gg+"','"+c3+"','"+MontaguDB.INTERPOLATED_POPULATION+"','"+MontaguDB.UNWPP_2015+"')");
            }
          }
        }
      } 
