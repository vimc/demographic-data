        ...
        if (pick_country) {
          ...
          for (byte g=0; g<no_genders; g++) {
            ...
            for (int y=1950; y<=1989; y++) {
              for (int a=0; a<=79; a++) {
                stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                                   a+","+a+","+get(a,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30',"+MontaguDB.UNWPP_ESTIMATES+",'"+gg+"','"+c3+"','"+MontaguDB.INTERPOLATED_POPULATION+"','"+MontaguDB.UNWPP_2012+"')");
            ...
            for (int y=1990; y<=2100; y++) {
              ...
              for (int a=0; a<=99; a++) {
                stmt.executeUpdate("INSERT INTO demographic_statistic (age_from,age_to,value,date_start,date_end,projection_variant,gender,country,demographic_statistic_type,source) values ("+
                    a+","+a+","+get(a,i3,g,y)+",'"+y+"-07-01','"+(y+1)+"-06-30',"+proj+",'"+gg+"','"+c3+"','"+MontaguDB.INTERPOLATED_POPULATION+"','"+MontaguDB.UNWPP_2012+"')");
